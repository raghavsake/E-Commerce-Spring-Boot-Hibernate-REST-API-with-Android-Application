...
public class ShippingRepository {
    ...
    public LiveData<ResponseBody> addShippingAddress(Shipping shipping) {
        ...
        RetrofitClient.getInstance().getApi().addShippingAddress(shipping.getAddress(),
                shipping.getCity(),shipping.getCountry(),shipping.getZip(),
                shipping.getPhone(),shipping.getUserId(),
                shipping.getProductId()).enqueue(new Callback<ResponseBody>() {
            @Override
