...
import com.project.ecommerce.adapter.WordAdapter;
import com.project.ecommerce.databinding.ActivitySearchBinding;
...
public class SearchActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, com.project.ecommerce.R.layout.activity_search);
